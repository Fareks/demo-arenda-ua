    ...
    return (
        <div className="main-section-container">
            <div className="text-area">
                ...
                <h1>ORENDA.UA - знайти бажане у кілька кліків!</h1>
                <p className="secondary-text">
                Скористайся нашими послугами у сфері підбору та оренди нерухомості. Отримай консультацію від кваліфікованих спеціалістів нашої компанії безкоштовно.
                </p>
                <Link to="/catalog">
